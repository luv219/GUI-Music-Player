...
- [ ] Output zip file is named correctly `PyTuneBox-vX.X.X.zip`.
- [ ] Extracting zip yields the standalone folder.
- [ ] Running EXE from extracted folder works perfectly.

## 12. GitHub / Portfolio Readiness Tests

- [ ] README is complete.
- [ ] Screenshots folder exists.
- [ ] Demo folder exists.
- [ ] Documentation files exist.
- [ ] Packaging guide exists.
- [ ] Release notes exist.
- [ ] Changelog exists.
- [ ] Security file exists.
- [ ] Contributing file exists.
- [ ] Project summary exists.
- [ ] Portfolio presentation exists.
- [ ] `.gitignore` excludes build artifacts.
- [ ] Source app runs with `python main.py`.
- [ ] Tests run with `pytest`.
- [ ] Windows EXE build script exists.
- [ ] Release ZIP script exists.
